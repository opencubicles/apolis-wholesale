  ...
  var Cart = /*#__PURE__*/function () {
    ...
    _createClass(Cart, [{
      ...
      value: function _calculateMiniCartHeight() {
        if ( true || Responsive.getCurrentBreakpoint() === 'phone') {
          if (this.isMiniCartOpen) {
            ...
            var miniCartContentElement = this.miniCartElement.querySelector('.mini-cart__content'),
                ...
                miniCartAlertElement = this.miniCartElement.querySelector('.mini-cart__alert-wrapper');

            if (miniCartRecapElement) {
              maxHeight -= miniCartAlertElement.clientHeight + 1;
            }
  ...
  var ProductVariants = /*#__PURE__*/function () {
    ...
    _createClass(ProductVariants, [{
      ...
      value: function _updateInventory(newVariant) {
        ...
        if(variantInventoryMessage == "Select one") {
          variantInventoryMessage = "Select a customization option";
        }
      ...
      value: function _addToCart(event, target) {
        ...
        var productFormData = Form.serialize(formElement);
        fetch("".concat(window.routes.cartAddUrl, ".js"), {
          ...
          if (response.ok) {
            var tag_variant_ele = document.getElementById("tag_variant_id");
            var customized_text_tag_id = document.getElementById("customized-text-tag");

            if (tag_variant_ele && customized_text_tag_id.textContent) {
              // alert(customized_text_tag_id.textContent);
              var formData = {
                items: [],
              };

              formData.items.push({
                id: tag_variant_ele.value,
                quantity: productFormData.quantity,
                properties: {
                  customization: customized_text_tag_id.textContent,
                },
              });
